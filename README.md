The Volition Protocol: A Framework for Stochastic Consensus and Logic Hardening
...
​3.2 Stateless Adversarial Nodes (SAN) - The Thank Tank
...
​Logic State (Lh) = Synthesis (PSC State + Sum of Adversarial Critiques)
